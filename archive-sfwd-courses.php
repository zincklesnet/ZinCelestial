...
<div class="zc-layout zc-layout--<?php echo esc_attr($layout); ?> zc-container">
  ...
  <main id="primary" class="zc-main zc-courses-archive" role="main">
    <header class="zc-page-header"><h1 class="zc-page-header__title"><?php esc_html_e('Courses','zincelestial'); ?></h1></header>
    <?php if(have_posts()): ?>
      <div class="zc-courses-grid">
        <?php while(have_posts()): the_post(); get_template_part('template-parts/content/content', 'sfwd-courses'); endwhile; ?>
      </div>
